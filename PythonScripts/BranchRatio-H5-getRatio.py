...
#locate the metadata
import dendropy
ds=dendropy.DataSet.get_from_path("/Volumes/Xueting2019/0617-serverdownload-needed/0603-H5-Egypt-all-branchrates/comb/editTreeBranchRates/H5-Egypt-all-parbran-combanno.trees", "nexus", extract_comment_metadata=True)
...
for trees in ds.tree_lists:
    ...
    for tree in trees:
        ...
        for nd in tree:
            ...
            ds.write_to_path('H5outfileWithMedian.tree','nexus',
