...
#locate the metadata
import dendropy
ds=dendropy.DataSet.get_from_path("/Volumes/Xueting2019/0617-serverdownload-needed/0617-H3N2withVaccine/comb/branchRatio-comparedwithMedian/H3N2outfileWithMedian.tree", "nexus", extract_comment_metadata=True)
    ...
    for tree in trees:
        ...
        for nd in tree:
            ...
            if x1 is None or x2 is None:
                continue;
            nd.HeadRatiodif=float(x1)/float(x2)-0.6718
            #print(nd.HeadRatio)
            ...
            if y1 is None or y2 is None:
                continue;
            nd.StalkRatiodif=float(y1)/float(y2)-0.2175
            nd.annotations.add_bound_attribute("StalkRatiodif")  
            #print(tree.as_string("nexus")) 
            ds.write_to_path('H3N2outfile-comparedtoMeidan.tree','nexus',
