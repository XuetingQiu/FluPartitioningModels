...
#locate the metadata
import dendropy
ds=dendropy.DataSet.get_from_path("/Volumes/Xueting2019/0617-serverdownload-needed/0617-withVaccine/comb/branchRatio/H3N2withVaccines-parRate-combanno.trees", "nexus", extract_comment_metadata=True)
