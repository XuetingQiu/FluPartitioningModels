...
#locate the metadata
import dendropy
ds=dendropy.DataSet.get_from_path("/Volumes/Xueting2019/0617-serverdownload-needed/0617-H3N2withVaccine/comb/branchRatio-comparedwithMedian/H3N2outfile-comparedtoMeidan.tree", "nexus", extract_comment_metadata=True)
...
for trees in ds.tree_lists:
    ...
    for tree in trees:
        ...
        for nd in tree:
            ...
            ds.write_to_path('H3N2outfileWithMedian2cats.tree','nexus',
